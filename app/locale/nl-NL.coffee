module.exports = nativeDescription: "Nederlands (Nederland)", englishDescription: "Dutch (Netherlands)", translation:
  ...
  new_home:
    slogan: "Het meest uitdagende spel om te leren programmeren."
    ...
    getting_students: "Het leerlingen zo snel mogelijk echte code laten schrijven is noodzakelijk voor het leren van programmeersyntax en correcte structuur."
    educator_resources: "Lesbrieven voor docenten"
    course_guides: "en ondersteuningsmateriaal"
    teaching_computer_science: "Je hebt geen informaticadiploma nodig om te kunnen programmeren; wij verschaffen de materialen waarmee elke docent programmeerles kan geven."
    ...
    compared: "vergeleken"
    conventional: "met conventionele leermethodes, is het verschil duidelijk: games stimuleren beter bij het onthouden van kennis, helpen de concentratie en het"
    perform_at_higher_level: "verhogen hun prestaties."
    feedback: "Games geven directe feedback, wat leerlingen in staat stelt hun oplossingen te verbeteren en waardoor zij een holistisch begrip van de concepten krijgen. Dit is een groot verschil met een simpele reactie als “correct” of “incorrect”."
    real_game: "Een echt spel, dat je speelt met echte programmeertaal."
    great_game: "Een goed spel is meer dan alleen medailles verdienen en presteren. Een goed spel is een reis met nauwkeurig ontworpen puzzels en de mogelijkheid om uitdagingen vol zelfvertrouwen aan te pakken."
    ...
    computer_science: "Informaticalessen voor alle leeftijden"
    show_me_lesson_time: "Geef geschatte lesduur weer:"
    curriculum: "Totaal aantal lesuren:"
    ffa: "Gratis voor alle leerlingen"
    lesson_time: "Lesduur:"
    coming_soon: "Binnenkort beschikbaar!"
    courses_available_in: "Lessen zijn beschikbaar in JavaScript en Python (binnenkort in Java!)"
    boast: "Uitdagende raadsels die zowel gamers als fanatieke programmeurs weten te prikkelen."
    winning: "Een gouden combinatie van spel&shy;elementen en programmeerhuiswerk, dat samen zorgt voor kindvriendelijk en daadwerkelijk goed onderwijs."
    run_class: "Alles wat je nodig hebt om vandaag nog programmeerlessen in jouw klas te geven. Er is geen voorkennis vereist!"
    teachers: "Docenten!"
...
#    jobs_benefit_9: "10-year option exercise window"
  ...
  courses:
    ...
    length: "Lengte:"
    title: "Cursussen" # Flat style redesign
    subtitle: "Bekijk cursusrichtlijnen, oplossingen en levels."
  ...
  teacher:
    ...
    teacher_account_explanation: "Een CodeCombat Docentenaccount kun je klassen aanmaken, voortgang van je leerlingen tijdens een cursus bekijken, inschrijvingen beheren en hulpmiddelen voor het opzetten van een leerplan gebruiken."
...
#    tournament_blurb_ace_of_coders: "Battle it out in the frozen glacier in this domination-style mirror match! The tournament began on Wednesday, September 16 and will run until Wednesday, October 14 at 5PM PDT. Check out the details"
  ...
  concepts:
    ...
    break_statements: "Break-instructies"
    classes: "Klassen"
    continue_statements: "Continue instructie"
    for_loops: "For Loops"
    functions: "Functies"
    graphics: "Graphics"
    if_statements: "If-instructies"
    input_handling: "Afhandeling van invoer"
...
#    object_literals: "Object Literals"
  ...
  legal:
    page_title: "Juridische informatie"
    opensource_intro: "CodeCombat is gratis en volledig open source."
    opensource_description_prefix: "Bekijk "
    github_url: "onze GitHub"
    opensource_description_center: "en help ons als je wilt! CodeCombat is gebouwd met de hulp van tientallen open source-projecten en dat vinden we geweldig. Bekijk ook "
    archmage_wiki_url: "onze Tovenaarswiki"
